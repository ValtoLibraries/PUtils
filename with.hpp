...
//      { pmeta_with(_.attachComponent<kengine::TransformComponent3d>()) {  // "_" is provided by pmeta_with
//          _.boundingBox.topLeft.x = 0;                                    // "_" is provided by pmeta_with
//          _.boundingBox.topLeft.y = 1;
//      }}
//
